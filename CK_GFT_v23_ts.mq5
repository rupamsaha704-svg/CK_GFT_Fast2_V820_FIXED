//+------------------------------------------------------------------+
//|  CK_GFT_v23_ts.mq5 = v23 (identical logic) + time,profit dump    |
//|  so we can combine v23 + AMA into a portfolio equity curve and    |
//|  measure the COMBINED drawdown (the diversification test).        |
//+------------------------------------------------------------------+
#property copyright "CK GFT v23 ts"
#property version   "23.20"
#property strict
...
double OnTester(){
   int h=FileOpen("ck_v23ts_trades.csv", FILE_WRITE|FILE_CSV|FILE_COMMON|FILE_ANSI, ",");
   if(h!=INVALID_HANDLE){
