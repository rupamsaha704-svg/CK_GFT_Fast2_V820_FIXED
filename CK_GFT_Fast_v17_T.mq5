//+------------------------------------------------------------------+
//|                                             CK_GFT_Fast_v17.mq5  |
//|  Base: v16 + SELL side + RR 1:3                                   |
//|                                                                    |
//|  CHANGES from v16:                                                 |
//|   - RR: 2.5 -> 3.0 (Risk:Reward = 1:3)                            |
//|   - ADDED: SELL side (mirror of BUY logic)                        |
//|                                                                    |
//|  BUY setup (unchanged):                                            |
...
//+------------------------------------------------------------------+
#property copyright "CK GFT Fast v17"
...
input double InpRR               = 3.0;   // CHANGED v17: was 2.5, now 3.0 (1:3)
...
//=== APPENDED FOR HONEST VALIDATION (logic unchanged) ==============
// Writes each CLOSED trade as (ENTRY time, net profit) to a COMMON CSV the pipeline reads.
// Self-contained: uses only standard history functions; does not touch v17 logic/inputs.
double OnTester()
{
   ...
   int h = FileOpen("ck_v17t_trades.csv", FILE_WRITE|FILE_CSV|FILE_COMMON|FILE_ANSI, ",");
   if(h != INVALID_HANDLE)
   {
