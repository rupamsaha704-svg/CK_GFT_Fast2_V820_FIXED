...
//+------------------------------------------------------------------+
//| Lot: auto-risk targeting $85, clamp [0.06,0.09], skip if <0.06    |
//| Also applies no-martingale ceiling. Returns 0 => skip trade.      |
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
//| Daily loss budget check: would this trade risk breaching $90/day? |
//+------------------------------------------------------------------+
...
void OpenBuy()
{
   ...
   if(lot<=0) return;   // skip (SL too wide or below min lot)

   // Daily $90 guard: if this trade's max loss + today's loss > cap -> skip
...
//+------------------------------------------------------------------+
//| Manage open trade: 0.01 lock (2min,25%) + BE (65%)               |
//+------------------------------------------------------------------+
void ManageTrade()
{
   ...
   //=== 0.01 LOCK: only after 2 min AND >= 25% progress ===
...
//+------------------------------------------------------------------+
//| Daily loss hard stop (equity-based intraday, $90 cap)            |
//+------------------------------------------------------------------+
bool DailyLossGuard()
{
