...
//+------------------------------------------------------------------+
#property copyright "CK GFT Fast v24"
...
input double InpTP1Progress      = 0.25;   // v24: at 25% of TP distance (was 0.10)
input double InpTP1CloseRatio    = 0.25;   // close 25% (=0.02 on 0.08 lot)
input bool   InpUsePartialTP2    = false;  // TP2 REMOVED - rest (0.06) runs to full TP
