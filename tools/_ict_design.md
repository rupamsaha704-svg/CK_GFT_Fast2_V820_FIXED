...
Γöé                        CK_XAU_ICT_ChoCh_V1.mq5                     Γöé
...
Γöé                                                                     Γöé
Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ    ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ    ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  Γöé
Γöé  Γöé  H1 Analysis Γöé    Γöé M15 Analysis Γöé    Γöé    M5 Execution      Γöé  Γöé
Γöé  Γöé              Γöé    Γöé              Γöé    Γöé                      Γöé  Γöé
Γöé  Γöé ΓÇó Swing Det. ΓöéΓöÇΓöÇΓöÇΓû╢Γöé ΓÇó Swing Det. ΓöéΓöÇΓöÇΓöÇΓû╢Γöé ΓÇó Confirm. Candle    Γöé  Γöé
Γöé  Γöé ΓÇó CHoCH Det. Γöé    Γöé ΓÇó BOS Det.   Γöé    Γöé ΓÇó Entry Logic        Γöé  Γöé
Γöé  Γöé ΓÇó POI Zone   Γöé    Γöé ΓÇó OB Zone    Γöé    Γöé ΓÇó Order Placement    Γöé  Γöé
Γöé  Γöé ΓÇó Bias Mgmt  Γöé    Γöé ΓÇó Fib Calc   Γöé    Γöé ΓÇó Trade Management   Γöé  Γöé
Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ    ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ    ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ  Γöé
Γöé         Γöé                    Γöé                      Γöé               Γöé
Γöé         Γû╝                    Γû╝                      Γû╝               Γöé
...
Γöé  Γöé                     State Manager                            Γöé   Γöé
Γöé  Γöé  IDLE ΓåÆ H1_CHOCH ΓåÆ WAIT_POI ΓåÆ M15_BOS ΓåÆ WAIT_OTE ΓåÆ OPEN   Γöé   Γöé
...
Γöé         Γû╝                    Γû╝                      Γû╝               Γöé
Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ   Γöé
Γöé  Γöé                   Risk & Protection Layer                    Γöé   Γöé
Γöé  Γöé  ΓÇó Position Sizing  ΓÇó Daily Loss Limit  ΓÇó Static DD Guard   Γöé   Γöé
Γöé  Γöé  ΓÇó Spread Filter    ΓÇó Max Trades/Day    ΓÇó Min Hold Time     Γöé   Γöé
Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ   Γöé
Γöé         Γöé                                                           Γöé
Γöé         Γû╝                                                           Γöé
Γöé  ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ   Γöé
Γöé  Γöé                     Logger / Diagnostics                     Γöé   Γöé
Γöé  ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ   Γöé
...
H1 (via CopyRates, checked on new H1 bar)
  Γöé
  Γöé Detects: Swing Highs/Lows, CHoCH events, POI zones
  Γöé Outputs: bias_direction, poi_zone{high, low}
  Γöé
  Γû╝
M15 (via CopyRates, checked on new M15 bar)
  Γöé
  Γöé Preconditions: H1 bias active, price near POI zone
  Γöé Detects: Swing Highs/Lows, BOS events, Order Blocks
  Γöé Outputs: bos_confirmed, ob_zone{high, low}, fib_levels{618, 705, 786}
  Γöé
  Γû╝
M5 (native chart, checked on new M5 bar)
  Γöé
  Γöé Preconditions: M15 BOS active, price in OTE zone
  Γöé Detects: Confirmation candles (Engulfing, Doji+Follow, Pin Bar)
  Γöé Outputs: entry_signal{direction, price, pattern_type}
  Γöé
  Γû╝
Execution (on M5 candle close ΓåÆ next tick)
  Γöé Validates: Spread, Margin, Daily Limits, DD, Max Trades
  Γöé Places: Market order with SL + TP1/TP2
  Γöé Manages: Partial close, BE, TP2 close
```
...
- H1 uses `bars_required = 3` (InpH1SwingBars) ΓÇö stronger structure
- M15 uses `bars_required = 2` (InpM15SwingBars) ΓÇö faster detection
- Only the two most recent swing highs/lows are tracked per timeframe
- Swing detection runs on completed bars only (shift ΓëÑ bars_required)

### 2.2 CHoCH Detection Algorithm

CHoCH is detected when the prevailing trend structure is violated ΓÇö price breaks a swing point against the established direction.
...
```
                    ...
                    Γöé                                             Γöé
                    Γû╝                                             Γöé
    ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ  H1 CHoCH   ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ                 Γöé
    Γöé  IDLE  ΓöéΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓû╢Γöé H1_CHOCH_DETECTEDΓöé                 Γöé
    ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ              ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ                 Γöé
        Γû▓                           Γöé                            Γöé
        Γöé                    Price enters                        Γöé
        Γöé                    H1 POI zone                         Γöé
        Γöé                           Γöé                            Γöé
        Γöé                           Γû╝                            Γöé
        Γöé               ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ               Γöé
        Γöé               Γöé WAITING_FOR_POI_RETESTΓöé               Γöé
        Γöé               ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ               Γöé
        Γöé                           Γöé                            Γöé
        Γöé                    M15 BOS confirmed                   Γöé
        Γöé                           Γöé                            Γöé
        Γöé                           Γû╝                            Γöé
        Γöé               ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ               Γöé
        Γöé               Γöé   M15_BOS_CONFIRMED   Γöé               Γöé
        Γöé               ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ               Γöé
        Γöé                           Γöé                            Γöé
        Γöé                    OTE zone calculated                 Γöé
        Γöé                    + validated                          Γöé
        Γöé                           Γöé                            Γöé
        Γöé                           Γû╝                            Γöé
        Γöé               ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ   Timeout/    Γöé
        Γöé               Γöé WAITING_FOR_OTE_ENTRY ΓöéΓöÇΓöÇΓöÇInvalidateΓöÇΓöÇΓöÿ
        Γöé               ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
        Γöé                           Γöé
        Γöé                    Confirmation candle
        Γöé                    + all filters pass
        Γöé                           Γöé
        Γöé                           Γû╝
        Γöé               ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
        Γöé               Γöé    POSITION_OPEN      Γöé
        Γöé               ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
        Γöé                           Γöé
        Γöé                    TP1 hit + partial close
        Γöé                    + BE applied
        Γöé                           Γöé
        Γöé                           Γû╝
        Γöé               ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
        ...
        Γöé               ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
        Γöé                           Γöé
        Γöé                    TP2 hit OR SL (at BE)
        Γöé                           Γöé
        Γöé                           Γû╝
        Γöé               ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
        ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöé      COMPLETED        Γöé
...
*A property is a characteristic or behavior that should hold true across all valid executions of a system ΓÇö essentially, a formal statement about what the system should do. Properties serve as the bridge between human-readable specifications and machine-verifiable correctness guarantees.*
...
*For any* trade with entry price E and SL distance D, TP1 must equal E ┬▒ (D ├ù RR_TP1) and TP2 must equal E ┬▒ (D ├ù RR_TP2), where the sign matches the trade direction.

**Validates: Requirements 6.1, 6.2**

### Property 13: Partial Close Volume Correctness

*For any* position volume V and lot_step S, the partial close amount must equal floor(V ├ù partial_percent / 100 / S) ├ù S. If the remaining volume after partial close is below minimum lot, the entire position must be closed.

**Validates: Requirements 6.3, 6.6**

### Property 14: Lot Size Calculation and Normalization

*For any* account balance B, risk percent R, SL distance D (in points), and point value P, the calculated lot must satisfy: raw_lot = (B ├ù R/100) / (D ├ù P), final_lot = min(floor(raw_lot / lot_step) ├ù lot_step, max_lot). If final_lot < min_lot, the trade must be rejected.
...
*For any* initial balance I and current balance C, static drawdown equals (I - C) / I ├ù 100. When this value reaches or exceeds the configured threshold, all positions must be closed and no new trades shall be permitted until restart.
...
*For any* two consecutive trades where the first trade resulted in a loss, the lot size of the second trade must be computed solely from the lot formula (balance ├ù risk / SL) and must not incorporate any multiplier or increase based on the prior loss outcome.
...
Γö£ΓöÇΓöÇ Header (copyright, version, #property)
Γö£ΓöÇΓöÇ #include <Trade/Trade.mqh>
Γö£ΓöÇΓöÇ Input Parameters Block
Γö£ΓöÇΓöÇ Enum Definitions (ENUM_BIAS, ENUM_SETUP_STATE, ENUM_CANDLE_PATTERN)
Γö£ΓöÇΓöÇ Struct Definitions (SwingPoint, CHoCH_Event, BOS_Event, OTE_Zone, TradeSetup, DayState)
Γö£ΓöÇΓöÇ Global State Variables
Γö£ΓöÇΓöÇ Utility Functions (Price normalization, logging, tick helpers)
Γö£ΓöÇΓöÇ Swing Detection Functions (IsSwingHigh, IsSwingLow)
Γö£ΓöÇΓöÇ H1 Analysis (DetectCHoCH, FindPOI)
Γö£ΓöÇΓöÇ M15 Analysis (DetectBOS, FindM15OrderBlock, CalculateOTE)
Γö£ΓöÇΓöÇ M5 Analysis (Confirmation candle detection)
Γö£ΓöÇΓöÇ Risk/Protection Layer (CalcVolume, PreTradeChecks, CheckStaticDrawdown, CheckDailyLoss)
Γö£ΓöÇΓöÇ Trade Execution (BuildTradeSetup, ExecuteTrade)
Γö£ΓöÇΓöÇ Trade Management (ManageOpenPosition, partial close, BE)
Γö£ΓöÇΓöÇ State Machine (TransitionState, InvalidateSetup)
Γö£ΓöÇΓöÇ OnInit() ΓÇö validation, indicator handles, data loading
Γö£ΓöÇΓöÇ OnDeinit() ΓÇö cleanup
ΓööΓöÇΓöÇ OnTick() ΓÇö main event loop
```
