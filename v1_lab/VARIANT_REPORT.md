...
| 15 | max_trades_4 | INSUFFICIENT | 97 | 1.09 | 6.08 | 33.51 |  | max trades/day = 4 (looser cap) |
| 16 | rr_3 | INSUFFICIENT | 77 | 1.10 | 5.88 | 17.90 |  | fixed_rr target = 3R |
| 17 | erl_lb_3 | INSUFFICIENT | 69 | 1.07 | 4.85 | 19.71 |  | ERL lookback = 3 swings (tighter external range) |
| 18 | disp_0p8 | INSUFFICIENT | 54 | 1.04 | 2.80 | 21.50 |  | MSS displacement gate = 0.8 (stricter) |
| 19 | sl_buf_1p0 | INSUFFICIENT | 73 | 0.99 | -0.90 | 21.71 |  | SL buffer = 1.0*ATR (wider) |
| 20 | erl_m15 | INSUFFICIENT | 51 | 0.90 | -6.29 | 22.47 |  | ERL source TF = M15 |
| 21 | poi_qm_fvg | INSUFFICIENT | 49 | 0.89 | -7.59 | 30.80 |  | POI type = qm_fvg (FVG confluence) |
| 22 | smt_xag | INSUFFICIENT | 9 | 0.85 | -8.08 | 5.80 |  | SMT pair = xag (needs XAGUSD series) |
| 23 | smt_dxy | INSUFFICIENT | 14 | 0.86 | -10.09 | 8.58 |  | SMT pair = dxy (needs DXY series) |
...
- trades: total 152, IS 77, OOS 75
- OOS: PF 1.24, expectancy 15.45, net 1158.54, win-rate 34.7%, max-DD 28.39%
- IS (exploration only): PF 1.00, expectancy -0.13
...
- M15 data: `v1_lab/data_drop/XAUUSD_M15_export.csv`  (100000 bars)
- M5 data: `v1_lab/data_drop/XAUUSD_M5_drop.csv`  (68418 bars)
