...
//|  Risk   : 1% per trade, max lot 0.08, 13% static DD limit       |
//|                                                                  |
...
//|      - Price must be IN the OTE zone                             |
//|      - Confirmation candle (Engulfing, Doji+Follow, Pin Bar)     |
...
#property strict
#property description "XAUUSD M5 ICT CHoCH + Fibonacci OTE Multi-TF Strategy V1"
...
bool PreTradeChecks(const TradeSetup &setup)
{
   ...
   // 6. Margin check (80% of free margin)
...
bool ExecuteTrade(TradeSetup &setup)
{
   ...
   string comment = StringFormat("ICT_ChoCh_%s_%s",
                    BiasToString(setup.direction),
...
int OnInit()
{
   LogMsg("INIT", "=== CK_XAU_ICT_ChoCh_V1 Initialization ===");
...
//+------------------------------------------------------------------+
//| End of CK_XAU_ICT_ChoCh_V1.mq5                                  |
//+------------------------------------------------------------------+
